...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css"
        integrity="sha512-tfRBUK1YTCVp86m6l9/2TJBy2rLi9O/8P6FFa3K6ZJ36Zihrvr5vNcLhE3CtIhwKRee0H5PTwMvXXoiqZ2P8dg=="
...
<body>
    <div class="content">
        ...
        <p><strong><?php echo date('Y-m-d', strtotime($event['dataRozpoczecia'])) . ' - ' . date('Y-m-d', strtotime($event['dataZakonczenia'])); ?></strong>
        </p>
        <p><strong>Godzina Rozpoczenia:</strong>
            <strong><?php echo date('H:i', strtotime($event['dataRozpoczecia'])); ?></strong></p>
        <p><?php echo htmlspecialchars($event['opis']); ?></p>

        <div class="button-container">
            <a href="dodaj-zadanie.php?taskDate=<?php echo htmlspecialchars(date('Y-m-d', strtotime($event['dataRozpoczecia']))); ?>"
                class="button">Dodaj do kalendarza <i class="far fa-calendar-plus" style="margin-left: 5px;"></i></a>
